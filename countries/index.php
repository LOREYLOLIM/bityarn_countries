...
<div class="container availability-form">
  <div class="row">
    ...
    <br><br>
      <h5 class="mb-4">Check Countries, Counties, Locations, Wards</h5>
      <form action="views.php" id="carform" method = "post">
        <div class="row align-items-end">

        
        <div class="col-lg-3 mb-3">
            <label class="form-label" style="font-weight: 500;" for="searchby">Choose a level:</label>
                <?php
                ...
                echo "</select>";
                ?>
                <input type = "submit" class="btn text-white shadow-none custome-bg" value = "submit" name = "levelsbtn">
